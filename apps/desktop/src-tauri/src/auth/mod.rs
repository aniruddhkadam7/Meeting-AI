//! REDLY Cloud authentication: signs a user in directly against Supabase
//! Auth (no REDLY-run auth server), stores the resulting session in Windows
...
/// Returns a still-valid access token for calling REDLY Cloud, refreshing
