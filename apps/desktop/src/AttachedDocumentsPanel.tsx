...
/// Lists documents actually uploaded to the RAG service (the same list
/// Preparation.tsx's now-unused "Your Documents" card shows) — Settings'
...
/// moments ago until Start is pressed — polling (like Preparation.tsx did)
/// picks that up shortly after rather than needing a manual refresh.
