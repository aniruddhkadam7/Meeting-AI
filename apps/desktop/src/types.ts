...
export const PREDEFINED_ROLES: { value: PredefinedRole; label: string }[] = [
...
export type AgentAnswerLength = "concise" | "balanced" | "detailed" | "adaptive";
export type AgentResponseStyle = "natural" | "professional" | "friendly" | "technical";
export type AgentAnswerFormat = "adaptive" | "paragraph" | "bullets" | "stepByStep";
export type AgentLiveAssistance = "manual" | "suggest" | "auto";

export interface AgentPersonalization {
  answerLength: AgentAnswerLength;
  responseStyle: AgentResponseStyle;
  answerFormat: AgentAnswerFormat;
  liveAssistance: AgentLiveAssistance;
}

export const DEFAULT_AGENT_PERSONALIZATION: AgentPersonalization = {
  answerLength: "adaptive",
  responseStyle: "natural",
  answerFormat: "adaptive",
  liveAssistance: "manual",
};

export interface Agent {
  id: string;
  name: string;
  baseRole: PredefinedRole | null;
