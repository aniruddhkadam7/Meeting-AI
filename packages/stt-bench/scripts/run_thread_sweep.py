...
Smallbird's hardcoded DEFAULT_NUM_THREADS=4 (packages/stt/streaming_asr_sidecar/
...
app reads — it points STT_MODEL_DIR at the same on-disk model Smallbird ships
